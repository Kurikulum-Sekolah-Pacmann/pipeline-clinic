...
def transform_patient(data: pd.DataFrame, table_name: str) -> pd.DataFrame:
    """
    ...
    try:
        ...
        data = data.rename(columns={'patient_id': 'patient_nk'})  
        
        # deduplication based on patient_nk
        data = data.drop_duplicates(subset='patient_nk')
